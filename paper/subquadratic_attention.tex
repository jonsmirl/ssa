...
adaptive case is machine-checked (\texttt{lossless\_adaptive\_reads\_every\_key}, over an explicit
...
private Substrate commit \texttt{908ec0d6d} machine-checks the corresponding results for recursive
...
statement is over an exact real inner-product space; floating-point consequences require a separate
outward-rounding argument.
...
to be rounded outward or inflated enough to cover accumulated error.
