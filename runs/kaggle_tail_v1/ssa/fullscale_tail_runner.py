...
def main():
    ...
    try:
        ...
        if gains.shape != (model.config.num_hidden_layers, model.config.num_attention_heads):
            raise ValueError("saved gain/model geometry mismatch")
        ...
        report["scope"] = "frozen 512-context gains; full official WikiText-2 test; unscaled positions; no new training; approximate tail, not a certificate"
